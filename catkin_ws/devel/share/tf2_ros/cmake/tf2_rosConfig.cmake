...
if("TRUE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2_ros)
  set(tf2_ros_DEVEL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/devel)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/install)
...
if(NOT "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2_ros/include " STREQUAL " ")
  set(tf2_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT tf2_ros_NUM_DUMMY_TARGETS)
      set(tf2_ros_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tf2_ros::wrapped-linker-option${tf2_ros_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tf2_ros_NUM_DUMMY_TARGETS "${tf2_ros_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tf2_ros::wrapped-linker-option${tf2_ros_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tf2_ros_LIBRARIES "${interface_target_name}")
