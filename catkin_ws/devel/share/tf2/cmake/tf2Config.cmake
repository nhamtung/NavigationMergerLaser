...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2)
  set(tf2_DEVEL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/install)
...
if(NOT "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2/include;/usr/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://www.ros.org/wiki/tf2 " STREQUAL " ")
    set(_report "Check the website 'http://www.ros.org/wiki/tf2' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/geometry2-melodic-devel/tf2/${idir}'.  ${_report}")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.0.4")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT tf2_NUM_DUMMY_TARGETS)
      set(tf2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tf2::wrapped-linker-option${tf2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tf2_NUM_DUMMY_TARGETS "${tf2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tf2::wrapped-linker-option${tf2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tf2_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tf2_dep}_FOUND)
      find_package(${tf2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tf2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
