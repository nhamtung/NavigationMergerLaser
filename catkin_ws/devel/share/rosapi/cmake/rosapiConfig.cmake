...
if("TRUE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/web_server/rosbridge_suite-master/rosapi)
  set(rosapi_DEVEL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/devel)
  set(rosapi_INSTALL_PREFIX "")
  set(rosapi_PREFIX ${rosapi_DEVEL_PREFIX})
else()
  set(rosapi_SOURCE_PREFIX "")
  set(rosapi_DEVEL_PREFIX "")
  set(rosapi_INSTALL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/install)
...
if(NOT "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/web_server/rosbridge_suite-master/rosapi/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosapi_NUM_DUMMY_TARGETS)
      set(rosapi_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosapi::wrapped-linker-option${rosapi_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosapi_NUM_DUMMY_TARGETS "${rosapi_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosapi::wrapped-linker-option${rosapi_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosapi_LIBRARIES "${interface_target_name}")
