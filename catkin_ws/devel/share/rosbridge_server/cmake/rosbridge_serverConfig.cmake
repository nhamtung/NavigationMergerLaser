...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/web_server/rosbridge_suite-master/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/robotics/TungNV/NavigationMergerLaser/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/web_server/rosbridge_suite-master/rosbridge_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosbridge_server_NUM_DUMMY_TARGETS)
      set(rosbridge_server_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosbridge_server::wrapped-linker-option${rosbridge_server_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosbridge_server_NUM_DUMMY_TARGETS "${rosbridge_server_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosbridge_server::wrapped-linker-option${rosbridge_server_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosbridge_server_LIBRARIES "${interface_target_name}")
