// Generated by gencpp from file sick_lidar_localization/SickLocRequestTimestampSrvResponse.msg
// DO NOT EDIT!


#ifndef SICK_LIDAR_LOCALIZATION_MESSAGE_SICKLOCREQUESTTIMESTAMPSRVRESPONSE_H
#define SICK_LIDAR_LOCALIZATION_MESSAGE_SICKLOCREQUESTTIMESTAMPSRVRESPONSE_H
...
struct SickLocRequestTimestampSrvResponse_
{
  ...
  typedef boost::shared_ptr< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocRequestTimestampSrvResponse_

typedef ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<std::allocator<void> > SickLocRequestTimestampSrvResponse;

typedef boost::shared_ptr< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse > SickLocRequestTimestampSrvResponsePtr;
typedef boost::shared_ptr< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse const> SickLocRequestTimestampSrvResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator1> & lhs, const ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xae8b1571bf8be63eULL;
  static const uint64_t static_value2 = 0x0bdad9873d14be2bULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_lidar_localization::SickLocRequestTimestampSrvResponse_<ContainerAllocator>& v)
  {
...
#endif // SICK_LIDAR_LOCALIZATION_MESSAGE_SICKLOCREQUESTTIMESTAMPSRVRESPONSE_H
