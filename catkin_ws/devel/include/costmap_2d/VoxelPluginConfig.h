...
namespace costmap_2d
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(VoxelPluginConfig &config, const VoxelPluginConfig &max, const VoxelPluginConfig &min) const
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const VoxelPluginConfig &config1, const VoxelPluginConfig &config2) const
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, VoxelPluginConfig &config) const
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const VoxelPluginConfig &config) const
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, VoxelPluginConfig &config) const
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const VoxelPluginConfig &config) const
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const VoxelPluginConfig &config, boost::any &val) const
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, VoxelPluginConfig &top) const
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(VoxelPluginConfig::AbstractParamDescriptionConstPtr(new VoxelPluginConfig::ParamDescription<int>("combination_method", "int", 0, "Method for combining two layers", "{'enum_description': 'Method for combining layers enum', 'enum': [{'srcline': 16, 'description': 'Overwrite values', 'srcfile': '/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/navigation-melodic-devel/costmap_2d/cfg/VoxelPlugin.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Overwrite'}, {'srcline': 17, 'description': 'Take the maximum of the values', 'srcfile': '/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/navigation-melodic-devel/costmap_2d/cfg/VoxelPlugin.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Maximum'}, {'srcline': 18, 'description': 'Do nothing', 'srcfile': '/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/navigation-melodic-devel/costmap_2d/cfg/VoxelPlugin.cfg', 'cconsttype': 'const int', 'value': 99, 'ctype': 'int', 'type': 'int', 'name': 'Nothing'}]}", &VoxelPluginConfig::combination_method)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 16 "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/navigation-melodic-devel/costmap_2d/cfg/VoxelPlugin.cfg"
      const int VoxelPlugin_Overwrite = 0;
//#line 17 "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/navigation-melodic-devel/costmap_2d/cfg/VoxelPlugin.cfg"
      const int VoxelPlugin_Maximum = 1;
//#line 18 "/home/robotics/TungNV/NavigationMergerLaser/catkin_ws/src/navigation-melodic-devel/costmap_2d/cfg/VoxelPlugin.cfg"
