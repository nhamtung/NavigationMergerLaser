// Generated by gencpp from file map_msgs/ProjectedMapsInfoRequest.msg
// DO NOT EDIT!
...
bool operator==(const ::map_msgs::ProjectedMapsInfoRequest_<ContainerAllocator1> & lhs, const ::map_msgs::ProjectedMapsInfoRequest_<ContainerAllocator2> & rhs)
{
  return lhs.projected_maps_info == rhs.projected_maps_info;
}
