...
"""autogenerated by genpy from map_msgs/OccupancyGridUpdate.msg. Do not edit."""
import codecs
import sys
...
class OccupancyGridUpdate(genpy.Message):
  _md5sum = "b295be292b335c34718bd939deebe1c9"
  _type = "map_msgs/OccupancyGridUpdate"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i2I().pack(_x.x, _x.y, _x.width, _x.height))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.width, _x.height,) = _get_struct_2i2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
