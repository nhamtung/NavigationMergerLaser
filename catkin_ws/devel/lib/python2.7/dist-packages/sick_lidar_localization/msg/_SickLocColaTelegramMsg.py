...
"""autogenerated by genpy from sick_lidar_localization/SickLocColaTelegramMsg.msg. Do not edit."""
import codecs
import sys
...
class SickLocColaTelegramMsg(genpy.Message):
  _md5sum = "fda058e73f190c37b2ae74d5f8aa66d7"
  _type = "sick_lidar_localization/SickLocColaTelegramMsg"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Definition of ros message SickLocColaTelegramMsg.
...
string frame_id
"""
  __slots__ = ['header','command_type','command_name','parameter']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,command_type,command_name,parameter
    ...
    """
    if args or kwds:
      super(SickLocColaTelegramMsg, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.command_type,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.command_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.command_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.parameter = []
