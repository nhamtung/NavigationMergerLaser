...
void AmclNode::checkLaserReceived(const ros::TimerEvent& event)
{
  ...
  {
    ROS_WARN("amcl_node.cpp-833-No laser scan received (and thus no pose updates have been published) for %f seconds.  Verify that data is being published on the %s topic.",
             d.toSec(),
